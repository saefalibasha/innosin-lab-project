      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Website Under Construction</h1>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Same content as the regular maintenance page but with standalone styling */}
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">info@innosinlab.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
