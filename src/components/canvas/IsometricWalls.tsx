...
const Wall = ({
  ...
  const wallGeometry = useMemo(() => {
    // ✅ Use raw world coordinates (no *0.1 magic factor)
    ...
    const thickness = (wall.thickness || 100); // Already in mm → convert if needed
    const height = 2400; // Standard 2.4m wall height in mm
