...
interface Enhanced3DControlsProps {
  ...
  onWallUpdate?: (updatedWall: WallSegment) => void; // ✅ Added this
}
...
const DragGizmo: React.FC<{
  ...
  return (
    <group position={position3D}>
      <mesh ref={meshRef} onPointerDown={handlePointerDown} visible={false}>
...
export const Enhanced3DControls: React.FC<Enhanced3DControlsProps> = ({
  ...
  const {
    ...
    scale,
    onProductUpdate,
    onWallUpdate // ✅ Pass it to the hook
  );
