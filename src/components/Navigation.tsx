    ...
    <nav className="glass-card border-b border-sea/10 fixed top-0 w-full z-50 shadow-lg backdrop-blur-16 animate-slide-down">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-28">
          {/* BRAND LOGO PLACEHOLDER - REPLACE THIS SECTION WITH YOUR LOGO */}
          {/* 
            TO ADD YOUR LOGO:
            1. Upload your logo image to the /public folder (e.g., /public/your-logo.png)
            2. Replace "/placeholder.svg" below with "/your-logo.png" 
            3. Adjust the width/height classes (w-10 h-10) as needed for your logo size
            4. Update the alt text to match your company name
            Recommended logo size: 40x40px to 60x60px
          */}
