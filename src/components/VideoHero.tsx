...
import { Reveal, ParallaxSection, StaggerList } from '@/components/anim';
import {
  Carousel,
  CarouselContent,
  CarouselItem,
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <CarouselContent className="-ml-2 md:-ml-4">
                {heroContent.slides.map((slide, idx) => (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
                          ...
                          <ParallaxSection offset={30}>
                            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-1 leading-[0.9] tracking-tight">
                              <span className="block text-sand-light">{slide.titles.title1}</span>
                            </h2>
                          </ParallaxSection>
                          
                          {/* Description */}
                          <Reveal delay={0.2}>
                            <p className="text-lg md:text-xl lg:text-2xl mb-2 max-w-4xl mx-auto text-white/90 leading-relaxed">
      ...
      <section className="py-6 bg-gradient-to-b from-background to-secondary/30 relative">
        <div className="container-custom text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <StaggerList
              items={[
                heroContent.ourStory.stats.projectsCompleted,
                heroContent.ourStory.stats.yearsOfExcellence,
                heroContent.ourStory.stats.researchInstitutions
              ]}
              renderItem={(stat) => (
                <div>
                  <div className="text-xl font-bold text-sea mb-1">{stat.number}</div>
